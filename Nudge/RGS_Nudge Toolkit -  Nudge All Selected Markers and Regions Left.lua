...
local function GetSelectedRegionsOrMarkers()
    ...
    if marker_count>0 then
        for i = 0, marker_count -1 do
            ...
            if reaper.GetRegionOrMarkerInfo_Value(0, marker, "B_UISEL") == 1 then
...
local function Main()
    ...
    local selected_markers = GetSelectedRegionsOrMarkers()
    if #selected_markers>0 then
        ...
        reaper.Undo_EndBlock("Nudge All Selected Markers and Regions Left",0)
    end
end
