...
local function GetSelectedVisibleMarkers()
    ...
    if marker_count>0 then
        for i = 0, marker_count -1 do
            ...
            if reaper.GetRegionOrMarkerInfo_Value(0, marker, "B_UISEL") == 1 and
               ...
               reaper.GetRegionOrMarkerInfo_Value(0, marker, "B_ISREGION") == 0 and
...
local function Main()
    ...
    local selected_markers = GetSelectedVisibleMarkers()
    if #selected_markers>0 then
        ...
        reaper.Undo_EndBlock("Nudge Visible Selected Markers Left",0)
    end
end
