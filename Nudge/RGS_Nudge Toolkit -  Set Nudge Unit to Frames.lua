...
local nudge_unit = 6
local unit_number = 18


if nudge_unit ~= tonumber(reaper.GetExtState("RGS_Nudge", "selected_nudge_unit")) or reaper.GetExtState("RGS_Nudge", "follow_ruler") == "true" then
    ...
    reaper.SetExtState("RGS_Nudge", "unit_switched", "true", true)
